...
inline hiprandStatus_t hiprandGenerateUniformHelper(hiprandGenerator_t, char *, size_t)
{
...
inline hiprandStatus_t hiprandGenerateNormalHelper(hiprandGenerator_t, char*, size_t, char, char)
{
    RuntimeError("Unsupported template argument(half) in GPUSparseMatrix");
}
